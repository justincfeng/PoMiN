...
test_particle_system = pomin.merge_particle_systems(PMars)

#-----------------------------------------------------------------------
#   INTEGRATION PARAMETERS
#-----------------------------------------------------------------------
tspan = (tpfl(0), tpfl(2.56E+13)) # about 4 years (more than 2 orbits of Mars)
...
# Save the plot
savefig(combined_plot, "Mars_orbit.png")
println("Plot saved as 'Mars_orbit.png'")
