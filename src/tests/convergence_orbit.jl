...
# δ = Double64(1)
# tspan = (Double64(0), Double64(80))

# Uncomment this section for orbit eccentricity = 0.95
Z_init = Double64[0 0 0 3860700000 0 0 0 -3.73E-12 0 0 3.73E-12 0] # Mercury orbiting Sun w eccentricity=0.95
δ = Double64(1.23E+13)
...
for i in 0:numhalves-1
    ...
    #sol = hsintegrator(3, 2, Z_init, x -> pomin.dH(3, masses, x), timestep, Double64(1000/tspan[2]), tspan, maxit)
